 ...
 */
#include "stdafx.h"
#include "SWE_TemplateFilter.h"
#include <template_data.h>

/// Create filter shell
ADTF_FILTER_PLUGIN("SWE_TemplateFilter", OID_ADTF_TEMPLATE_FILTER, cSWE_TemplateFilter);


cSWE_TemplateFilter::cSWE_TemplateFilter(const tChar* __info):cFilter(__info)
{
...
cSWE_TemplateFilter::~cSWE_TemplateFilter()
{

}

tResult cSWE_TemplateFilter::Init(tInitStage eStage, __exception)
{
...
tResult cSWE_TemplateFilter::Shutdown(tInitStage eStage, __exception)
{
...
tResult cSWE_TemplateFilter::OnPinEvent(IPin* pSource,
                                           tInt nEventCode,
                                           tInt nParam1,
                                           tInt nParam2,
