#include <cmath>
#include "stdafx.h"
#include "SWE_SteeringControl.h"

#include <iostream>
#include <fstream>

ADTF_FILTER_PLUGIN("SWE SteeringControl", OID_ADTF_SWE_STEERINGCONTROL, cSWE_SteeringControl)

cSWE_SteeringControl::cSWE_SteeringControl(const tChar* __info) : cFilter(__info)
{
...
cSWE_SteeringControl::~cSWE_SteeringControl()
{
}

tResult cSWE_SteeringControl::CreateInputPins(__exception)
{
...
tResult cSWE_SteeringControl::CreateOutputPins(__exception)
{
...
tResult cSWE_SteeringControl::Init(tInitStage eStage, __exception)
{
...
tResult cSWE_SteeringControl::Start(__exception)
{
    return cFilter::Start(__exception_ptr);
}

tResult cSWE_SteeringControl::Stop(__exception)
{
    return cFilter::Stop(__exception_ptr);
}

tResult cSWE_SteeringControl::Shutdown(tInitStage eStage, __exception)
{
    return cFilter::Shutdown(eStage,__exception_ptr);
}

tResult cSWE_SteeringControl::OnPinEvent(	IPin* pSource, tInt nEventCode, tInt nParam1, tInt nParam2, IMediaSample* pMediaSample)
{
